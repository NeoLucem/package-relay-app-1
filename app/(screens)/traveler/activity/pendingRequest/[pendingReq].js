...
const pendingReq = () => {
    ...
    const acceptRequest = async (requestId) => {
        ...
        const response = await acceptCarryRequest(requestId);
        console.log(response);
        setLoading(false);
        Alert.alert('Request Accepted', 'You have successfully accepted the request');
        } catch (error) {
        throw new Error(error);
        }
    }
            ...
            <ScrollView className="h-full bg-white">
                ...
                <View className="gap-2 justify-center items-center mb-2">
                    <TouchableOpacity 
                        ...
                        className="p-4  rounded-xl border-2 border-black  min-h-[24px] w-[90%] bg-black-100 flex justify-center items-center">
                ...
                <View className="gap-2 justify-center items-center mb-6">
                    <TouchableOpacity 
                        ...
                        className="p-4  rounded-xl border-2 border-red-600 min-h-[24px] w-[90%] bg-red-600 flex justify-center items-center">
