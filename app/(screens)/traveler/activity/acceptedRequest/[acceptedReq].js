...
import { fetchUserData, fetchSinglePackage, getSinglePackage, fetchSingleTrip, declineCarryRequest, confirmRequest } from '../../../../lib/firebaseConfig';
...
const acceptedReq = () => {
    ...
    const confirmReq = async (requestId) => {
        ...
        console.log(response);
        setLoading(false);
        Alert.alert('Request Confirmed', 'You have successfully confirmed the request');
        } catch (error) {
        throw new Error(error);
        }
    }
