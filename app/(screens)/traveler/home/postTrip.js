...
const postTrip = () => {
    ...
    const postTrip = async () =>{
        console.log('Posting trip', fromVal, toVal, transportType, ndate, ntime, weight, bookingRef, companyName);
    }
            ...
            <View className="w-full">
                ...
                <View className="w-[96%]" style={{gap: 2}}>
                    <TouchableOpacity 
                        ...
                        className="p-4 rounded-lg border-2 border-black-100 min-h-[12px] w-[93%] bg-white flex justify-center items-center"
                    >
                        <Text className="text-black">Show Date Picker</Text>
                    </TouchableOpacity>
                    <TouchableOpacity 
                        onPress={showTimePicker}
                        className="p-4 rounded-lg border-2 border-black-100 min-h-[12px] w-[93%] bg-white flex justify-center items-center"
                    >
                        <Text className="text-black">Show Time Picker</Text>
                    </TouchableOpacity>
                    <TextInput 
                        keyboardType='numeric' 
                        className="bg-white w-[93%] h-12 border-solid rounded-lg border-black-100 border-2 pl-2" 
